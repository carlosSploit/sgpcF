...
export async function getActivProsAnali(idVersionAnali = 0) {
  const url = `${domain_api}/activprosveranali/${idVersionAnali}`;
...
export async function addActivProsAnali(jsondat = {}) {
  const data = jsondat;
  const url = `${domain_api}/activprosveranali/`;
