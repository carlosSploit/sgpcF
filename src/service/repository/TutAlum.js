...
export async function gettutoralum() {
  const url = `${domain_api}/tutalm/`;
...
export async function addtutalum(jsondat = {}) {
  const data = jsondat;
  const url = `${domain_api}/tutalm/`;
...
// export async function updatealumn(id, jsondat = {}) {
//   const id_negocio = id;
//   const data = jsondat;
//   const url = `${domain_api}/alumn/${id_negocio}`;
