...
import { addContentActiv } from "../../../../../../../../../../../../service/repository/Contenactiv";

export function AddContTarea(props){
    ...
    const handleSubmit = async (event) => {
        ...
        let resul = await addContentActiv(data);
        console.log(resul);
    ...
    return (
        <>
           ...
           <ComponentModalFloting statemode={ismodalvisible} onClosechange={()=>{setismodalvisible(false);limpiarcastillas();}}>
               <ComponentModalFlotingHeader title="Insertar una Tarea" onClosechange={()=>{setismodalvisible(false);limpiarcastillas();}} />
               <ComponentModalFlotingBody descripccion={"Ingresa el nombre de la tarea, una descripccion de lo que trata la tarea, y la url del contenido como redireccion."}>
               <form
                    style={{
                        margin: "0",
                        padding: "0",
                ...
                >
                    ...
                    <Forminput textinput={textnombrcontses} settextinput={settextnombrcontses} placeHolder="Nombre de la tarea" keyname ={"nomcont"} />
                    <ForminputArea textinput={descripcontses} settextinput={setdescripcontses} placeHolder="Descripccion de la tarea" keyname ={"descrcont"} />
                    {/* <Forminputnumber textinput={textdiasdura} settextinput={settextdiasdura} placeHolder="Dias de duracion" keyname ={"diadu"}/> */}
                    <Forminput textinput={urlcontent} settextinput={seturlcontent} placeHolder="Url de la tarea" keyname ={"urlcont"}/>
