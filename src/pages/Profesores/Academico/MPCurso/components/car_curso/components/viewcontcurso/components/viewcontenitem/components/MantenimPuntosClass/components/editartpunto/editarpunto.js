...
import { DeleteinscripPuntosClass, getInscripPointoSesion } from "../../../../../../../../../../../../../../service/repository/inscripuntosclass";
...
function EditarPunto(props){
    ...
    const onDeletPunto = async () => {
        ...
        const resul = await DeleteinscripPuntosClass(data);
    ...
    const getpuntclass = async (id_Inscrip = 0) => {
        let resul = await getInscripPointoSesion(dataac.id_sesion, (id_Inscrip == 0)? idselectInscrip:id_Inscrip);

        console.log(`idsesion : ${dataac.id_sesion} - idselectInscrip : ${idselectInscrip}`);
        console.log(resul);
    ...
    return (
        <>
            <ComponentModalFlotingBody>
                ...
                <ForminputBotton label = "Quitar un punto" onChange={onDeletPunto} />
            </ComponentModalFlotingBody>
        </>
    );
}
