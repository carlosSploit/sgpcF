...
import "./style/EditContSession.css";
...
import { Forminput, ForminputArea, ForminputBottonSubmit, ForminputRadioSlice, FormListchipts} from "../../../../../../../../../../../../service/morvius-service/form";
...
export function EditContSession(props){
    ...
    const handleSubmit = async (event) => {
        ...
        let resul = await updatContentSession(dataac.id_conte_sesion,data);
        console.log(resul);
    ...
    return (
        <>
           ...
           <ComponentModalFloting statemode={ismodalvisible} onClosechange={()=>{setismodalvisible(false);}}>
               <ComponentModalFlotingHeader title="Insertar un Contenido" onClosechange={()=>{setismodalvisible(false);}} />
               ...
               <form
                ...
                >
                    ...
                    <Forminput valueInit={dataac.nombre_conte} textinput={textnombrcontses} settextinput={settextnombrcontses} placeHolder="Nombre del contenido" keyname ={"nomcont"} />
                    <ForminputArea valueInit={dataac.descripccion} textinput={descripcontses} settextinput={setdescripcontses} placeHolder="Descripccion del contenido" keyname ={"descrcont"} />
                    {/* <Forminputnumber textinput={textdiasdura} settextinput={settextdiasdura} placeHolder="Dias de duracion" keyname ={"diadu"}/> */}
                    <Forminput valueInit={dataac.url_contenido} textinput={urlcontent} settextinput={seturlcontent} placeHolder="Url de contenido" keyname ={"urlcont"}/>
