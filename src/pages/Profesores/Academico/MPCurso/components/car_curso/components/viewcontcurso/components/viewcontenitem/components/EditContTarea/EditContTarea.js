...
import "./style/EditContTarea.css";
...
import { Forminput, ForminputArea, ForminputBottonSubmit} from "../../../../../../../../../../../../service/morvius-service/form";
...
// import { updatContentSession } from "../../../../../../../../../../../../service/repository/Contensesion";
import { updatContentActiv } from "../../../../../../../../../../../../service/repository/Contenactiv";

export function EditContTarea(props){
    ...
    const handleSubmit = async (event) => {
        ...
        let resul = await updatContentActiv(dataac.id_conte_tarea,data);
        console.log(resul);
    ...
    return (
        <>
           ...
           <ComponentModalFloting statemode={ismodalvisible} onClosechange={()=>{setismodalvisible(false);}}>
               <ComponentModalFlotingHeader title="Editar tarea" onClosechange={()=>{setismodalvisible(false);}} />
               <ComponentModalFlotingBody descripccion={"Edita el nombre de la tarea, una descripccion de lo que trata la tarea, y la url de la tarea como redireccion."}>
               <form
                    style={{
                        margin: "0",
                        padding: "0",
                ...
                >
                    ...
                    initvalue={dataac.id_tipo_conte} isActionChips = {false} onChangeItems={onChangeItemslistprofe}/>:<></>} */}
                    <Forminput valueInit={dataac.nombre} textinput={textnombrcontses} settextinput={settextnombrcontses} placeHolder="Nombre de la tarea" keyname ={"nomcont"} />
                    <ForminputArea valueInit={dataac.descripc} textinput={descripcontses} settextinput={setdescripcontses} placeHolder="Descripccion de la tarea" keyname ={"descrcont"} />
                    {/* <Forminputnumber textinput={textdiasdura} settextinput={settextdiasdura} placeHolder="Dias de duracion" keyname ={"diadu"}/> */}
                    <Forminput valueInit={dataac.urlconte} textinput={urlcontent} settextinput={seturlcontent} placeHolder="Url de la tarea" keyname ={"urlcont"}/>
