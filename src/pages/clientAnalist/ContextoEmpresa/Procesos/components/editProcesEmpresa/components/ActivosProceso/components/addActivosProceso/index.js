...
export function AddActivosProceso(props){
    ...
    return (
        <>
            <PopModal namemodal = {"Enlazar un Activo"} colorTitle={'#183152'} propismodalvisible = {propismodalvisible} propsetismodalvisible = {propsetismodalvisible}>
