...
import { ExisteAnalistEmpresa } from "./components/existeActivosProceso";
// import { ExisteEmpresa } from "./components/existeAreaEmpresa";

export function AddAnalistEmpresa(props){
    ...
    const [listview,] = useState([<ExisteAnalistEmpresa onInsert = {onInsert} informationDataGeneral = {informationDataGeneral} />]);

    return (
        <>
            <PopModal namemodal = {"Enlazar un Analista"} colorTitle={'#183152'} propismodalvisible = {propismodalvisible} propsetismodalvisible = {propsetismodalvisible}>
