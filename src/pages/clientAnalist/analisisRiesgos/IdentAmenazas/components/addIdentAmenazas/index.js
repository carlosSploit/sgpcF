    ...
    return (
        <>
           <ComponentModalFloting statemode={propismodalvisible} width = {'400px'} >
                ...
                <ComponentModalFlotingBody descripccion={(isDescripccion)?'Selecciona su libreria de amenazas de preferencia, para cargar las primeras amenazas a este activo.':"Selecciona una amenaza que este alineado al activo."}>
                    {(listview.length != 0)?<>
