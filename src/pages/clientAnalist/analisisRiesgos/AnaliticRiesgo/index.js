...
export function AnaliticRiesgo(props){
    ...
    return (
        <div className="Container_AnaliticRiesgo_principal">
            <div className="Container_AnaliticRiesgo_principal_subConteiner">
                {/* Encabezado */}
                <div className="Container_AnaliticRiesgo_principal_header">
                    <div className="Container_AnaliticRiesgo_principal_header_subcontent_title">
                        <div className="Container_AnaliticRiesgo_principal_header_content_title">Analiticas de Valorizacion Riesgos</div>
                    </div>
                    <div className="Container_AnaliticRiesgo_principal_header_subcontent_search">
                        <div className="Container_AnaliticRiesgo_principal_header_subcontent_search_cont">
                            ...
                            <div style={{width:'5px'}}></div>
                            <div className="Container_AnaliticRiesgo_principal_header_subcontent_information" onClick={()=>{
                                setismodelaInfo(!ismodelaInfo)
                            }}>
                                <InfoOutlined className={'Container_AnaliticRiesgo_principal_header_subcontent_information_icon'} />
                            </div>
                        </div>
                        <div style={{width:'25px'}}></div>
                    </div>
                </div>
                <div className="Container_AnaliticRiesgo_principal_body_naster">
                    <div className="Container_AnaliticRiesgo_principal_body_naster_information">
                        {/* Generador */}
