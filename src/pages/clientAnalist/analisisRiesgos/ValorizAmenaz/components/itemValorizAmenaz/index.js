...
export function ItemValorizeAmenaz(props){
    ...
    return (<div className="Container_ItemValorizeAmenaz_conten_Pri">
        <div className="Container_ItemValorizeAmenaz_conten_secondary">
            ...
            {/* <div className="Container_ItemValorizeAmenaz_conten_secondary_seleccion">
                <div onClick={()=>{
                    onSelecteItem(keyitem,!isSeleteItem);
                    setisSeleteItem(!isSeleteItem);
                }} className={`Container_ItemValorizeAmenaz_conten_secondary_seleccion_radio${(isSeleteItem)?' active':''}`}><div></div></div>
            </div> */}
        </div>
    </div>);
}