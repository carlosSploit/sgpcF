...
import { analiicas_ciclo_curso_sincrono_puntos } from "../../../../../../../../../../service/repository/Analiticas";
// import { getRankpuntos } from "../../../../../../../../service/repository/ResulTarea";
// import { Forminput,
...
export function Viewrankpuntos(props){
    let {
        refaction,
        onAction = () =>{},
        dataac={
    ...
    const onListResultTarea = async () => {
        ...
        let result = await analiicas_ciclo_curso_sincrono_puntos(dataac.id_ciclo_curso);
        // console.log(result);
