    ...
    return (
        <>
           ...
           <ComponentModalFloting statemode={ismodalvisible} onClosechange={()=>{setismodalvisible(false);}}>
               <ComponentModalFlotingHeader title="Actualizar un ciclo de curso" onClosechange={()=>{setismodalvisible(false);}} />
               <ComponentModalFlotingBody descripccion={"Ingresa la fecha de inicio y de fin, el profesor, la cantidad de dias de duracion y el precio para editar a un ciclo de curso."}>
               <form
                    style={{
                        margin: "0",
                        padding: "0",
