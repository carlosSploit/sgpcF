...
export function ViewCicloCurso(props){
    let {
        refAction,
        onUpdate = () =>{},
        dataact={
            ...
            <ComponentModalPrincipalBody>
                    ...
                    <div className="container_view_curso_contain_info">
                        <div className="container_view_curso_contain_info_contain_title">
                            <div className="container_view_curso_contain_info_title">Ciclo de curso</div>
                        ...
                        <div className="container_view_curso_contain_info_body">
                            {(listciclocurso != null)?listciclocurso.map((item)=>{
                                return <Viewcontenitem onclickActionbasic={onlistciclocurso} onClickActions={onlistciclocurso} label={`Desde ${parsetieme(item.fecha_init)} hasta ${parsetieme(item.fecha_fin)}`} dataac={item} ></Viewcontenitem>;
                            }):<></>}
                        </div>
                    </div>
               </ComponentModalPrincipalBody>
