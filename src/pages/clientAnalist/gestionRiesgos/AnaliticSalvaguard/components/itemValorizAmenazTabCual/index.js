    ...
    return (
        <>
            <tr style={{height: "30px"}}>
                <th className="content-AnaliticSalvaguard-table-item-encabezado keyid cent" style={{width:"5%"}}>{itemdate.id_salvAfectAct}</th>
                <th className="content-AnaliticSalvaguard-table-item-encabezado lef">{itemdate.descripc}</th>
                <th className="content-AnaliticSalvaguard-table-item-encabezado lef ocp">
                    <div className="content-AnaliticSalvaguard-table-item-encabezado_chip ">
                        <div className="content-AnaliticSalvaguard-table-item-encabezado_chip_item" style={{backgroundColor:`${colorStadeDegradCualiti(itemdate.valDegraResidCuali)}`}}>{labelStadeDegradCualiti(itemdate.valDegraResidCuali)}</div>
                    </div>
                </th>
                <th className="content-AnaliticSalvaguard-table-item-encabezado lef ocp">
                    <div className="content-AnaliticSalvaguard-table-item-encabezado_chip ">
                        <ComponentToolTips asling={'center'} size={{w: 200,h: 24}} id={`x${itemdate.id_activProsVerAnali}`}
                            messege={<div style={{width: '100%', textAlign: 'center'}} >{labelStadeFrecunCualiti(itemdate.valEscalFrecuenResidCuali)}</div>}
                        >
                           <div className="content-AnaliticSalvaguard-table-item-encabezado_chip_item" style={{backgroundColor:`${colorStadeFrecunCualiti(itemdate.valEscalFrecuenResidCuali)}`}}>{itemdate.valEscalFrecuenResidCuali}</div>
                        </ComponentToolTips>
                    </div>
                </th>
                <th className="content-AnaliticSalvaguard-table-item-encabezado lef ocp">
                    <div className="content-AnaliticSalvaguard-table-item-encabezado_chip ">
                        <ComponentToolTips asling={'center'} size={{w: 200,h: 24}} id={`x${itemdate.id_activProsVerAnali}`}
                            messege={<div style={{width: '100%', textAlign: 'center'}} >{labelStadeImpactCualiti(itemdate.valImpactResidCuali)}</div>}
                        >
                           <div className="content-AnaliticSalvaguard-table-item-encabezado_chip_item" style={{backgroundColor:`${colorStadeImpactCualiti(itemdate.valImpactResidCuali)}`}}>{itemdate.valImpactResidCuali}</div>
                        </ComponentToolTips>
                    </div>
                </th>
                <th className="content-AnaliticSalvaguard-table-item-encabezado lef">
                    <div className="content-AnaliticSalvaguard-table-item-encabezado_chip ">
                        <ComponentToolTips asling={'center'} size={{w: 200,h: 24}} id={`x${itemdate.id_activProsVerAnali}`}
                            messege={<div style={{width: '100%', textAlign: 'center'}} >{labelStadeRiesgCualiti(itemdate.valRiesgResidCuali)}</div>}
                        >
                           <div className="content-AnaliticSalvaguard-table-item-encabezado_chip_item" style={{backgroundColor:`${colorStadeRiesgCualiti(itemdate.valRiesgResidCuali)}`}}>{itemdate.valRiesgResidCuali}</div>
                        </ComponentToolTips>
                    </div>
                </th>
            </tr>
