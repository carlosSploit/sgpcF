...
export function OpccionActionsRecurSalvagur(props){
    ...
    return (
        <div className="Content_AreaEmpresas_principal_opccion">
            <div className='Content_AreaEmpresas_principal_opccion_Botton_Config' onClick={()=>{setisPressOptions(!isPressOptions);}}>
