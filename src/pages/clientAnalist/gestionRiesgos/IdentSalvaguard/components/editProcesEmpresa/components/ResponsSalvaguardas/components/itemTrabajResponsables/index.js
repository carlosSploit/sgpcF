...
export function ItemTrabajResponsab(props){
    ...
    return (<div className="Container_ItemAreaEmpresa_conten_Pri">
        <div className="Container_ItemAreaEmpresa_conten_secondary">
            <div className="Container_ItemAreaEmpresa_conten_secondary_seleccion_conten_information" onClick={()=>{
                onChange(keyitem);
            }}>
            ...
            <div className="Container_ItemAreaEmpresa_conten_secondary_seleccion">
                <div onClick={()=>{
                    onSelecteItem(keyitem,!isSeleteItem);
                    setisSeleteItem(!isSeleteItem);
                }} className={`Container_ItemAreaEmpresa_conten_secondary_seleccion_radio${(isSeleteItem)?' active':''}`}><div></div></div>
            </div>
        </div>
    </div>);
}